...
def generate_output2():
    ...
    try:
        ...
        # คำนวณลำดับจาก Grand Total ต่อหมวดหมู่2
        ...
        ordered_cols = ["ลำดับ", "หมวดหมู่2", "หมวดหมู่3"] +                        [col for col in pivot.columns if col not in ["ลำดับ", "หมวดหมู่2", "หมวดหมู่3", "Grand Total"]] +                        ["Grand Total"]
